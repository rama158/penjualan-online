...
$query = "SELECT kode_brg, nama_brg, harga FROM brg";
...
<body>
    ...
    <form action="proses-tambah-transaksi.php" method="post">
        ...
        <br>  
        Harga Barang: <input type="number" name="harga-brg" id="harga-brg" readonly><br />
        <br>
        Jumlah: <input type="number" name="jumlah-brg"><br />
        <br>
        Total Harga: <input type="number" name="tot-hrg" readonly><br />
        <br>
...
<script>
    document.querySelector('select').addEventListener('change', function() {
      ...
      document.getElementById('harga-brg').value = selectedOpt.dataset.harga;
    })
